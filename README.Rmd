...
- [`R/`](https://github.com/mcpri3/Plants/tree/master/R):
...
Launch the [`make.R`](https://github.com/mcpri3/Plants/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/mcpri3/Plants/blob/main/CONTRIBUTING.md).
